...
class estate_property(models.Model):
    ...
    # date_availibilty=fields.Date("Date Availibilty", copy=False,Date = datetime.datetime.now(),
    #                                                             EndDate = datetime.timedelta(month=6))
    # date_availibilty=fields.Datetime(default=lambda self: fields.Date.context_today(self) + relativedelta(months=3))
